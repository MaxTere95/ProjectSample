...
group = "ru.maxtere.sampleserver.spring.hibernate"
version = "1.0.0"

dependencies {
    implementation(projects.shared.server.springHibernate)
}
...
tasks.withType<org.springframework.boot.gradle.tasks.bundling.BootJar> {
    mainClass.set("ru.maxtere.sampleserver.spring.hibernate.ApplicationKt")
